...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Quote, follow up, invoice, and get paid. One product. One loop. No bloat." },
...
function RootComponent() {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <div className="qp-ambient" aria-hidden />
      <div className="qp-grid" aria-hidden />
      <Outlet />
